...
import static ru.fildv.openclassroomutil.util.UrlPath.COURSE_CANSEL;
import static ru.fildv.openclassroomutil.util.UrlPath.LOGIN;

@WebServlet(COURSE_CANSEL)
public class CourseCanselServlet extends HttpServlet {
    ...
    protected void doGet(final HttpServletRequest req,
        ...
        courseStudentService.cansel(idCourse, user.id());
