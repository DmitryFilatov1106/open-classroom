...
import static ru.fildv.openclassroomutil.util.UrlPath.COURSE_NEXT_STATUS;

@WebServlet(COURSE_NEXT_STATUS)
public class CourseNextStatusServlet extends HttpServlet {
    ...
    protected void doGet(final HttpServletRequest req,
        ...
        try {
            ...
            var status = courseService.nextStatus(idCourse);
